      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto mb-12 md:mb-20">
          ...
          <motion.p 
             ...
             className="text-sm md:text-lg text-slate-600 leading-relaxed max-w-xl mx-auto font-medium"
          >
            Using latest technology for precise and painless care.
          </motion.p>
        </div>

        <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-3 gap-3 md:gap-8 pb-16 md:pb-0">
